...
\begin{frame}
  \begin{center}
    \Huge Algoritmo del vecino más cercano
  \end{center}
\end{frame}
...
\begin{frame}\frametitle{Eficiencia Teórica}
  Despreciando las constantes, el cálculo de la eficiencia es:
  $$n*\sum_{k=1}^{n}k = n*\frac{(n+1)*n}{2} = \frac{n^3+n^2}{2}$$
  Eficiencia: $O(n^3)$ \\
  % \vspace{2mm}
  % Donde:\\
  % k: tamaño del vector result (find)\\
  % n: tamaño del vector candidates
\end{frame}

\subsection{Algoritmo de insercción}

\begin{frame}
  \begin{center}
    \Huge Algoritmo de insercción
  \end{center}
\end{frame}
...
\subfigure[\tiny Algoritmo de cercanía. Peso = 103]{\label{graf:ulysses16_nearest}\includegraphics[width=45mm]{graficas/ulysses16_nearest}}
\subfigure[\tiny Algoritmo de inserción. Peso = 72]{\label{graf:ulysses16_insertion}\includegraphics[width=45mm]{graficas/ulysses16_insertion}}
\subfigure[\tiny Algoritmo doubleNearest. Peso = 101]{\label{graf:ulysses16_...}\includegraphics[width=45mm]{graficas/ulysses16_doubleNearest}}
\end{figure}
\end{frame}
...
\subfigure[\tiny Algoritmo de cercanía. Peso = 830]{\label{graf:st70_nearest}\includegraphics[width=45mm]{graficas/st70_nearest}}
\subfigure[\tiny Algoritmo de inserción. Peso = 754]{\label{graf:st70_insertion}\includegraphics[width=45mm]{graficas/st70_insertion}}
\subfigure[\tiny Algoritmo doubleNearest. Peso = 958]{\label{graf:st70_...}\includegraphics[width=45mm]{graficas/st70_doubleNearest}}
\end{figure}
\end{frame}
...
\subfigure[\tiny Algoritmo de cercanía. Peso = 651]{\label{graf:gr202_nearest}\includegraphics[width=45mm]{graficas/gr202_nearest}}
\subfigure[\tiny Algoritmo de inserción. Peso = 554]{\label{graf:gr202_insertion}\includegraphics[width=45mm]{graficas/gr202_insertion}}
\subfigure[\tiny Algoritmo doubleNearest. Peso = 688]{\label{graf:gr202_...}\includegraphics[width=45mm]{graficas/gr202_doubleNearest}}
\end{figure}
\end{frame}
...
\subfigure[\tiny Algoritmo de cercanía. Peso = 4046]{\label{graf:gr666_nearest}\includegraphics[width=45mm]{graficas/gr666_nearest}}
\subfigure[\tiny Algoritmo de inserción. Peso = 3656]{\label{graf:gr666_insertion}\includegraphics[width=45mm]{graficas/gr666_insertion}}
\subfigure[\tiny Algoritmo doubleNearest. Peso = 4452]{\label{graf:gr666_...}\includegraphics[width=45mm]{graficas/gr666_doubleNearest}}
\end{figure}
\end{frame}
...
\subfigure[\tiny Algoritmo de cercanía. Peso = 331103]{\label{graf:pr1002_nearest}\includegraphics[width=45mm]{graficas/pr1002_nearest}}
\subfigure[\tiny Algoritmo de inserción. Peso = 316968]{\label{graf:pr1002_insertion}\includegraphics[width=45mm]{graficas/pr1002_insertion}}
\subfigure[\tiny Nuestro algoritmo. Peso = 385020]{\label{graf:pr1002_...}\includegraphics[width=45mm]{graficas/pr1002_doubleNearest}}
\end{figure}
\end{frame}
