...
\title{Práctica 1: Análisis de la eficiencia de algoritmos}  
...
\begin{frame}{Algoritmos de orden de eficiencia $O(n^2)$} 

\begin{figure}[H]
  \centering
  \subfigure{\label{graf:n2}\includegraphics[width=95mm]{graficos/on2}}
\end{figure}

\end{frame}

\subsection{Algoritmos de orden de eficiencia $O(n\log n)$}
\begin{frame}{Algoritmos de orden de eficiencia $O(n\log n)$}

  \begin{figure}[H]
    \centering
    \subfigure{\label{graf:nlogn}\includegraphics[width=95mm]{graficos/onlogn}}
    \end{figure}
  
  \end{frame}

\subsection{Algoritmos de orden de eficiencia $O(n^3)$}
\begin{frame}{Algoritmos de orden de eficiencia $O(n^3)$}

  \begin{figure}[H]
    \centering
    \subfigure{\label{graf:n3}\includegraphics[width=95mm]{graficos/on3}}
    \end{figure}
  
  \end{frame}

\subsection{Algoritmos de orden de eficiencia $O(2^n)$}
\begin{frame}{Algoritmos de orden de eficiencia $O(2^n)$}

  \begin{figure}[H]
    \centering
    \subfigure{\label{graf:2n}\includegraphics[width=95mm]{graficos/o2n}}
    \end{figure}
...
\begin{frame}{Algoritmos de ordenación}
  ...
  \begin{figure}[H]
    \centering
    \subfigure{\label{graf:sort}\includegraphics[width=95mm]{graficos/sort}}
    \end{figure}
...
\begin{frame}[fragile]{Algoritmos con orden de eficiencia $O(n^2)$} 
...
\begin{flushleft}
  Coeficientes obtenidos para algoritmo de ordenación por burbuja:
\end{flushleft}
...
\subfigure{\includegraphics[width=95mm]{graficos/burbuja_ajust}}
\end{figure}
...
\vspace{-3mm}
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=70mm]{graficos/insercion_ajust}}
\end{figure}
...
\vspace{-3mm}
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=70mm]{graficos/seleccion_ajust}}
\end{figure}
...
\begin{frame}[fragile]{Algoritmos con orden de eficiencia $O(n\log n)$} 
...
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=95mm]{graficos/mergesort_ajust}}
\end{figure}
...
\vspace{-5mm}
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=70mm]{graficos/quicksort_ajust}}
\end{figure}
...
\vspace{-5mm}
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=70mm]{graficos/heapsort_ajust}}
\end{figure}
...
\begin{frame}[fragile]{Algoritmos con orden de eficiencia $O(n^3)$: Algoritmo de Floyd} 
...
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=95mm]{graficos/floyd_ajust}}
\end{figure}
...
\begin{frame}[fragile]{Algoritmos con orden de eficiencia $O(2^n)$: Algoritmo de Hanoi} 
...
\begin{figure}[H] \centering
\subfigure{\includegraphics[width=95mm]{graficos/hanoi_ajust}}
\end{figure}
...
\begin{frame}{Mergesort}
  \begin{figure}[H] \centering
\subfigure{\includegraphics[width=95mm]{graficos/mergesort_otros_ajust}}
\end{figure}
\end{frame}
...
\begin{frame}{Hanoi}
  \begin{figure}[H] \centering
\subfigure{\includegraphics[width=95mm]{graficos/hanoi_otros_ajust}}
\end{figure}
\end{frame}

\section{Variación de la eficiencia empírica con parámetros externos: Nivel de optimización}

\begin{frame}{Burbuja}
  \begin{figure}[H] \centering
  \subfigure{\includegraphics[width=95mm]{graficos/burbuja_op}}
\end{figure}
\end{frame}

\begin{frame}{Quicksort}
  \begin{figure}[H] \centering
  \subfigure{\includegraphics[width=95mm]{graficos/quicksort_op}}
\end{figure}
\end{frame}

\begin{frame}{Floyd}
  \begin{figure}[H] \centering
  \subfigure{\includegraphics[width=95mm]{graficos/floyd_op}}
\end{figure}
\end{frame}

\begin{frame}{Hanoi}
  \begin{figure}[H] \centering
  \subfigure{\includegraphics[width=95mm]{graficos/hanoi_op}}
\end{figure}
\end{frame}
