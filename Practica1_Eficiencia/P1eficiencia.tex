...
\begin{figure}[H] \centering
  \subfigure[\label{graf:burbuja-op}Burbuja]{\includegraphics[width=70mm]{graficos/burbuja_op}}
  \subfigure[\label{graf:quicksort-op}Quicksort]{\includegraphics[width=70mm]{graficos/quicksort_op}}
\end{figure}
\vspace{-10mm}
\begin{figure}[H] \centering
  \subfigure[\label{graf:floyd-op}Floyd]{\includegraphics[width=70mm]{graficos/burbuja_op}}
  \subfigure[\label{graf:burbuja-op}Hanoi]{\includegraphics[width=70mm]{graficos/burbuja_op}}
\end{figure}
