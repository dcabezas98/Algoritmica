...
\begin{frame}[fragile]\frametitle{Viajante de Comercio} 
  ...
  forma tal que la distancia recorrida sea mínima.
\end{frame}

\section{Algoritmos}

\begin{frame}[fragile]{Función cota}
  \begin{lstlisting}
...
\begin{frame}\frametitle{Comparación}
...
\begin{frame}
  ...
  \begin{enumerate}
  \item Greedy: el más rápido / solución aproximada
  \item Backtracking: lento / solución óptima
  \item Branch \& Bound: lento / solución óptima
    \end{enumerate}
\end{frame}
