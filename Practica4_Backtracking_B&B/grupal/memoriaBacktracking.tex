...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 55]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/a4}}
  \subfigure[Backtracking. Peso = 55]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/a4}}
  \subfigure[Branch and Bound. Peso = 55]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/a4}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 10060]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/att5}}
\subfigure[Backtracking. Peso = 10060]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/att5}}
\subfigure[Branch and Bound. Peso = 10060]{\label{graf:pr1002_...}\includegraphics[width=70mm]{graficas/B&B/att5}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 4244]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/bayg6}}
  \subfigure[Backtracking. Peso = 4244]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/bayg6}}
  \subfigure[Branch and Bound. Peso = 4244]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/bayg6}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 2218]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/berlin7}}
  \subfigure[Backtracking. Peso = 2218]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/berlin7}}
  \subfigure[Branch and Bound. Peso = 2218]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/berlin7}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 166]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/eil8}}
  \subfigure[Backtracking. Peso = 166]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/eil8}}
  \subfigure[Branch and Bound. Peso = 166]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/eil8}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 151]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/eil9}}
  \subfigure[Backtracking. Peso = 151]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/eil9}}
  \subfigure[Branch and Bound. Peso = 151]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/eil9}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 129]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/gr10}}
  \subfigure[Backtracking. Peso = 129]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/gr10}}
  \subfigure[Branch and Bound. Peso = 129]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/gr10}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 99]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/gr11}}
  \subfigure[Backtracking. Peso = 92]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/gr11}}
  \subfigure[Branch and Bound. Peso = 92]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/gr11}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 10656]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/kroD12}}
  \subfigure[Backtracking. Peso = 10047]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/kroD12}}
  \subfigure[Branch and Bound. Peso = 10047]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/kroD12}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 8351]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/pcb13}}
  \subfigure[Backtracking. Peso = 8351]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/pcb13}}
  \subfigure[Brach and Bound. Peso = 8351]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/pcb13}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 3565]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/pr14}}
  \subfigure[Backtracking. Peso = 3565]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/pr14}}
  \subfigure[Branch and Bound. Peso = 3565]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/pr14}}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Greedy. Peso = 3653]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Greedy/pr15}}
  \subfigure[Backtracking. Peso = 3579]{\label{graf:a4}\includegraphics[width=70mm]{graficas/Backtracking/pr15}}
  \subfigure[Branch and Bound. Peso = 3579]{\label{graf:a4}\includegraphics[width=70mm]{graficas/B&B/pr15}}
\end{figure}
